    ...
    return (
        ...
        <section className="h-screen w-full hero-bg-gradient relative -z-20">
            ...
            <div className="max-w-6xl mx-auto w-full h-full px-4 flex flex-col xl:flex-row">
                    ...
                    <div className="grid gap-5">
                        ...
                        >
                            <h1 className="flex gap-3 items-end">
                                <Image src={apple} className="w-4 -translate-y-0.5" alt="Apple logo" />
                                <p>Download on App Store</p>
                            </h1>
                        </Button>

                        {/* Profile pics + rating stars */}
                        <div className="flex items-center gap-4 mx-auto xl:mx-0 h-fit translate-x-8 xl:translate-x-0">
                            <div className="flex">
                                {/* Layered profile pics */}
                                <Image src={profilePic3} className="size-10 border-background object-cover border-3 rounded-full" alt="User 3" />
                                <Image src={profilePic2} className="size-10 border-background object-cover border-3 -translate-x-4 rounded-full" alt="User 2" />
                                <Image src={profilePic1} className="size-10 border-background object-cover border-3 -translate-x-8 rounded-full" alt="User 1" />
                                <span className="py-2.5 border-3 border-background px-1 text-xs font-semibold text-center align-center bg-primary -translate-x-12 rounded-full">
                                    10K+
                                </span>
                            </div>
                ...
                {/* RIGHT PART: Mockup Carousel (hidden on smaller screens) */}
